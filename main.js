...
camera.position.set(-10, 6, 5); // Adjust as needed
...
const ambientLight = new THREE.AmbientLight(0xffffff, 2); // Low intensity
scene.add(ambientLight);

// Load Environment Map (HDRI)
const rgbeLoader = new RGBELoader();
rgbeLoader.load('environment_2_2k.hdr', (texture) => {
...
loader.load(
  './Portfolio Set.glb', // Path to your GLTF file
  function (gltf) {
